...
{   
    ...
    while (teraz!=NULL)
    {
        if(strcmp(teraz -> kod_przed, kod_przed)==0)
        {
            printf("%s %s %s %s\n", teraz->kod_przed, teraz->nr_albumu, teraz->ocena, teraz->komentarz);
            n++;
        }
    ...
    if (n==0)
    {
        printf("Brak ocen dla danego kodu przedmiotu! \n");
    }
...
{   
    ...
    while (teraz!=NULL)
    {
        if(strcmp(teraz -> nr_albumu, nr_albumu)==0)
        {
            printf("%s %s %s %s\n", teraz->kod_przed, teraz->nr_albumu, teraz->ocena, teraz->komentarz);
            n++;
        }
    ...
    if (n==0)
    {
        printf("Brak ocen dla ucznia o danym numerze albumu! \n");
    }
